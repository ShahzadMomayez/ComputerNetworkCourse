...
int RIPTest::getASId(int routerId) {
    if (routerId < 17) {
        return 1;
    }
    return 2;
...
void RIPTest::assertExists(int routerId, int pcId, std::list<int> gatewayIds) {
...
void RIPTest::mesh_TopLeftCorner_ForwardingTableIsCorrect() {
...
void RIPTest::mesh_TopRightCorner_ForwardingTableIsCorrect() {
    assertExists(4, 24, {3});
    assertExists(4, 25, {3});
    assertExists(4, 26, {3});
    assertExists(4, 27, {3});
...
void RIPTest::mesh_BottomLeftCorner_ForwardingTableIsCorrect() {
...
void RIPTest::mesh_BottomRightCorner_ForwardingTableIsCorrect() {
...
void RIPTest::mesh_TopEdge_ForwardingTableIsCorrect() {
    assertExists(3, 24, {2});
    assertExists(3, 25, {2});
    assertExists(3, 26, {2});
    assertExists(3, 27, {2});
...
void RIPTest::mesh_BottomEdge_ForwardingTableIsCorrect() {
...
void RIPTest::mesh_LeftEdge_ForwardingTableIsCorrect() {
    assertExists(5, 24, {1});
    assertExists(5, 25, {1});
...
void RIPTest::mesh_RightEdge_ForwardingTableIsCorrect() {
...
void RIPTest::mesh_Middle_ForwardingTableIsCorrect() {
...
void RIPTest::torus_TopLeftCorner_ForwardingTableIsCorrect() {
    convertToTorus();
    assertExists(1, 24, {24});
    assertExists(1, 25, {25});
    assertExists(1, 26, {2});
...
void RIPTest::torus_TopRightCorner_ForwardingTableIsCorrect() {
    convertToTorus();
    assertExists(4, 24, {1});
    assertExists(4, 25, {1});
...
void RIPTest::torus_BottomLeftCorner_ForwardingTableIsCorrect() {
    convertToTorus();
...
void RIPTest::torus_BottomRightCorner_ForwardingTableIsCorrect() {
    convertToTorus();
...
void RIPTest::torus_TopEdge_ForwardingTableIsCorrect() {
    convertToTorus();
...
void RIPTest::torus_BottomEdge_ForwardingTableIsCorrect() {
    convertToTorus();
...
void RIPTest::torus_LeftEdge_ForwardingTableIsCorrect() {
    convertToTorus();
    assertExists(5, 24, {1});
    assertExists(5, 25, {1});
    assertExists(5, 26, {1, 6});
...
void RIPTest::torus_RightEdge_ForwardingTableIsCorrect() {
    convertToTorus();
...
void RIPTest::torus_Middle_ForwardingTableIsCorrect() {
    convertToTorus();    
...
void RIPTest::ringStar_CentralNode_ForwardingTableIsCorrect() {
...
void RIPTest::ringStar_SpokeNodeConnedtedToPCs_ForwardingTableIsCorrect() {
...
void RIPTest::ringStar_SpokeNodeNotConnedtedToPCs_ForwardingTableIsCorrect() {
...
void RIPTest::ringStar_NonSpokeNodeConnedtedToPCs_ForwardingTableIsCorrect() {
...
void RIPTest::ringStar_NonSpokeNodeNotConnedtedToPCs_ForwardingTableIsCorrect() {
